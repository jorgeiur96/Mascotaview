...
public class MainActivity extends AppCompatActivity {
   ...
   PojoMascota obj =  new PojoMascota();
    ...
    atribu.add(new PojoMascota(R.drawable.img1,"tonbie",0));
    atribu.add(new PojoMascota(R.drawable.img2,"tonbie",0));
    atribu.add(new PojoMascota(R.drawable.img3,"tonbie",0));
    atribu.add(new PojoMascota(R.drawable.img4,"tonbie",0));
    atribu.add(new PojoMascota(R.drawable.img5,"tonbie",0));
